...
export const MOCKUP_CONFIG:MockupConfig[] = [
    {
        title:"No frame",
        imagePath:"/images/mockups/no-frame.svg",
        type: MockupHeaderTypes.NO_FRAME
    },
    {
        title:"Macbook light",
        imagePath:"/images/mockups/mackbook-light.svg",
        type: MockupHeaderTypes.MACKBOOK_LIGHT
    },
    {
        title:"Macbook dark",
        imagePath:"/images/mockups/mackbook-dark.svg",
        type: MockupHeaderTypes.MACKBOOK_DARK
    },
    {
        title:"Window light",
        imagePath:"/images/mockups/window-light.svg",
        type: MockupHeaderTypes.WINDOWS_LIGHT
    },
    {
        title:"Window dark",
        imagePath:"/images/mockups/window-dark.svg",
